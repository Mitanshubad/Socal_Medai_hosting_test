...
const Navbar = () => {
  ...
  return (
    ...
    //             </div>
    //             <img src={man} alt='man img' className={classes.profileUserImg} onClick={()=> setShowModal(prev=>!prev)} />
    //             {
    //                 showModal && 
    ...
    //                  <div className={classes.upateProfileWrapper} onClick={(e)=>e.stopPropagation()}>
